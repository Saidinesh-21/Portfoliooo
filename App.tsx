...
const sampleTimelineData: TimelineEventData[] = [
  {
    ...
    media: [
      ...
      { type: MediaType.Image, src: 'https://drive.google.com/file/d/1bUoPEH0amNKtH0MUTfShCK5yHpMz4DFo/view?usp=sharing', altText: 'Early Vivo shot - Macro', description: 'Close-up of a flower, exploring macro.' },
