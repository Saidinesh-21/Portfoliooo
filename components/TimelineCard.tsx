    ...
    <div id={id} className="relative group">
      ...
      >
        <div className="flex items-start mb-4">
          <div className="flex-shrink-0 rounded-full overflow-hidden w-12 h-12 sm:w-16 sm:h-16 mr-4 border-2 border-[#9a8c98] flex justify-center items-center">
            <img
        ...
        {media && media.length > 0 && (
          <div className="mb-4 rounded-lg overflow-hidden border border-[#c9ada7]/50">
            {/* Pale Dogwood border for carousel on light bg */}
